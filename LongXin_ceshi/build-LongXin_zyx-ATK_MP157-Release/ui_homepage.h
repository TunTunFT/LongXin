...
public:
    ...
    void setupUi(QMainWindow *homepage)
    {
        ...
        homepage->setStyleSheet(QString::fromUtf8("QMainWindow#homepage{\n"
...
"}\n"
""));
        electric = new QLabel(layoutWidget1);
        ...
        layoutWidget->setGeometry(QRect(30, 70, 745, 331));
        ...
        pushButton_outdoor_temperature = new QPushButton(layoutWidget);
...
"background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, stop: 0 rgb(255, 242, 187), stop: 1 rgb(255, 223, 174));"));
        ...
        pushButton_indoor_temperature = new QPushButton(layoutWidget);
...
"background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, stop: 0 rgb(255, 242, 187), stop: 1 rgb(255, 223, 174));"));
        ...
        pushButton_v4l2 = new QPushButton(layoutWidget);
...
"background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, stop: 0 rgb(255, 242, 187), stop: 1 rgb(255, 223, 174));"));
        ...
        pushButton_liquid_level = new QPushButton(layoutWidget);
...
"background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, stop: 0 rgb(255, 242, 187), stop: 1 rgb(255, 223, 174));"));
        ...
        pushButton_gas = new QPushButton(layoutWidget);
...
"background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, stop: 0 rgb(255, 242, 187), stop: 1 rgb(255, 223, 174));"));
        ...
        pushButton_airpressure = new QPushButton(layoutWidget);
...
"background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, stop: 0 rgb(255, 242, 187), stop: 1 rgb(255, 223, 174));"));
        ...
        pushButton_access_control = new QPushButton(layoutWidget);
...
"background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, stop: 0 rgb(255, 242, 187), stop: 1 rgb(255, 223, 174));"));
        ...
        pushButton_setting = new QPushButton(layoutWidget);
...
"background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, stop: 0 rgb(255, 242, 187), stop: 1 rgb(255, 223, 174));"));
        ...
        homepage->setCentralWidget(layoutWidget1);
