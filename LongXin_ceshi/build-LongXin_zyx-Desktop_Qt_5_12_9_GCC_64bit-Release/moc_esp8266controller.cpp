...
#include "../LongXin_zyx/Esp8266Controller/esp8266controller.h"
...
QT_MOC_LITERAL(1, 18, 13), // "statusUpdated"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 6), // "status"
QT_MOC_LITERAL(4, 40, 14) // "handleResponse"

    },
    "Esp8266Controller\0statusUpdated\0\0"
    "status\0handleResponse"
};
...
void Esp8266Controller::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->handleResponse(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Esp8266Controller::statusUpdated)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Esp8266Controller::statusUpdated(const QString & _t1)
{
